                      ...
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            ...
                            if(empty($row['branch_name']) || $row['branch_name']=='0'){
                             }else{
                   ...
                   <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <input  type="text" class="mdc-text-field__input" readonly="" name="name" value="<?php echo $row['name']; ?>"  placeholder="Name" >
                            <div class="mdc-text-field__bottom-line"></div>
                          </div>
                        </div>
                      </div>
                     ...
                     <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <?php 
                            if(empty($row['father_name']) || $row['father_name']=='0'){
                              ?>
                              <input  type="text" class="mdc-text-field__input" value="" name="fathername" placeholder="Father's Name">
                          <?php   }else{
                            ?>
                            <input  type="text" readonly="" class="mdc-text-field__input" value="<?php echo $row['father_name']; ?>" name="fathername" placeholder="Father's Name">
                    ...
                    <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <?php 
                            if( empty($row['gurdian_name']) || $row['gurdian_name']=='0'){
                              ?>
                              <input  type="text" class="mdc-text-field__input" value="" name="gurdianname" placeholder="Guardian's Name">
                          <?php   }else{
                            ?>
                            <input  type="text" readonly="" class="mdc-text-field__input" value="<?php echo $row['gurdian_name']; ?>" name="gurdianname" placeholder="Guardian's Name">
                      ...
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            ...
                            <input  type="text" readonly="" class="mdc-text-field__input" value="<?php echo $row['gender']; ?>" name="gender" placeholder="gender">
                        ...
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box mdc-text-field--with-leading-icon w-100">
                            <i class="material-icons mdc-text-field__icon" tabindex="0">event</i>
                             ...
                             <input type="date" readonly=""  class="mdc-text-field__input" name="dob" placeholder="YYYY/MM/DD" value="<?php echo $row['dob']; ?>" >
                    ...
                    <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <?php 
                            if( empty($row['mother_name']) || $row['mother_name']=='0'){
                              ?>
                               <input  type="text" class="mdc-text-field__input" name="mother" value="" placeholder="Mother's Name">
                          <?php   }else{
                            ?>
                           <input  type="text" readonly="" class="mdc-text-field__input" name="mother" value="<?php 
                      ...
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                              ...
                              <?php 
                            if(empty($row['marital_status']) || $row['marital_status']=='0'){
                              ?>
                            ...
                            <?php }else{
                              ?>
                <input  type="text" readonly="" class="mdc-text-field__input" name="marital" value="<?php 
                    ...
                    <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <?php 
                            if( empty($row['h_w_name']) || $row['h_w_name']=='0'){
                              ?>
                               <input  type="text" class="mdc-text-field__input" name="hwname" value="" placeholder="Housband or Wife Name">
                          <?php   }else{
                            ?>
                           <input  type="text" readonly="" class="mdc-text-field__input" name="hwname" value="<?php 
                    ...
                    <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                             <?php 
                            if( empty($row['child_no']) || $row['child_no']=='0'){
                              ?>
                               <input  type="number" class="mdc-text-field__input" value=""  name="child" placeholder="No Of Child">
                          <?php   }else{
                            ?>
                          <input  type="number" readonly="" class="mdc-text-field__input" value="<?php 
                   ...
                   <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <?php 
                            if(empty($row['handicap']) || $row['handicap']=='0'){
                              ?>
                            ...
                            <?php }else{
                              ?>
                <input  type="text" readonly="" class="mdc-text-field__input" name="handicap" value="<?php 
                      ...
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            ...
                            <?php 
                            if(empty($row['catagory_cast']) || $row['catagory_cast']=='0'){
                              ?>
                            ...
                            <?php }else{
                              ?>
                <input  type="text" readonly="" class="mdc-text-field__input" name="cast" value="<?php 
                           
                              echo $row['catagory_cast'];
                     ...
                     <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <?php 
                            if(empty($row['x_ser_man']) || $row['x_ser_man']=='0'){
                              ?>
                            ...
                            <?php }else{
                              ?>
                <input  type="text" readonly="" class="mdc-text-field__input" name="serviceman" value="<?php 
                     ...
                     <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <?php 
                            if(empty($row['religion']) || $row['religion']=='0'){
                              ?>
                            ...
                            <?php }else{
                              ?>
                <input  type="text" readonly="" class="mdc-text-field__input" name="religion" value="<?php 
                   ...
                   <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <input  type="text" class="mdc-text-field__input" value="<?php 
                            if(empty($row['acd_1']) || $row['acd_1']=='0'){
                             }else{
                              echo $row['acd_1'];
                             }
                     ...
                     <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <input  type="text" class="mdc-text-field__input" value="<?php 
                            if(empty($row['acd_2']) || $row['acd_2']=='0'){
                             }else{
                              echo $row['acd_2'];
                             }
                    ...
                    <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <input  type="text" class="mdc-text-field__input" value="<?php 
                            if(empty($row['acd_3']) || $row['acd_3']=='0'){
                             }else{
                              echo $row['acd_3'];
                             }
                      ...
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            ...
                            if(empty($row['acd_email']) || $row['acd_email']=='0'){
                             }else{
                              echo $row['acd_email'];
                             }
                   ...
                   <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <input  type="text" class="mdc-text-field__input" value="<?php 
                            if(empty($row['mobile_no']) || $row['mobile_no']=='0'){
                             }else{
                              echo $row['mobile_no'];
                             }
                     ...
                     <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <input  type="text" class="mdc-text-field__input" value="<?php 
                            if(empty($row['pad_2']) || $row['pad_2']=='0'){
                             }else{
                              echo $row['pad_2'];
                             }
                    ...
                    <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <input  type="text" class="mdc-text-field__input" value="<?php 
                            if(empty($row['pad_3']) || $row['pad_3']=='0'){
                             }else{
                              echo $row['pad_3'];
                             }
                    ...
                    <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <input  type="text" class="mdc-text-field__input" value="<?php 
                            if(empty($row['pad_lm']) || $row['pad_lm']=='0'){
                             }else{
                              echo $row['pad_lm'];
                             }
                    ...
                    <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <input  type="text" class="mdc-text-field__input" value="<?php 
                            if(empty($row['pad_dist']) || $row['pad_dist']=='0'){
                             }else{
                              echo $row['pad_dist'];
                             }
                    ...
                    <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <input  type="text" class="mdc-text-field__input" value="<?php 
                            if(empty($row['cd_lm']) || $row['cd_lm']=='0'){
                             }else{
                              echo $row['cd_lm'];
                             }
                    ...
                    <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <input  type="text" class="mdc-text-field__input" value="<?php 
                            if(empty($row['cd_city']) || $row['cd_city']=='0'){
                             }else{
                              echo $row['cd_city'];
                             }
                    ...
                    <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <input  type="text" class="mdc-text-field__input" value="<?php 
                            if(empty($row['cd_state']) || $row['cd_state']=='0'){
                             }else{
                              echo $row['cd_state'];
                             }
                    ...
                    <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <input  type="text" class="mdc-text-field__input" value="<?php 
                            if(empty($row['cd_dist']) || $row['cd_dist']=='0'){
                             }else{
                              echo $row['cd_dist'];
                             }
                      ...
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            ...
                            if(empty($row['cd_pin']) || $row['cd_pin']=='0'){
                             }else{
                              echo $row['cd_pin'];
                             }
                        ...
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            ...
                            <select class="mdc-text-field__input" name="eq_details">
                              <?php 
                            if(empty($row['edu_qua']) || $row['edu_qua']=='0'){
                              ?>
                              <option value="">Please Select</option>
                            <?php }else{
                              ?>
                    ...
                    <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <input  type="text" class="mdc-text-field__input" value="<?php 
                            if(empty($row['pass_year']) || $row['pass_year']=='0'){
                             }else{
                              echo $row['pass_year'];
                             }
                    ...
                    <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <input  type="text" class="mdc-text-field__input" value="<?php 
                            if(empty($row['roll_no']) || $row['roll_no']=='0'){
                             }else{
                              echo $row['roll_no'];
                             }
                      ...
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box  w-100">
                            ...
                            <input type="text"  class="mdc-text-field__input" value="<?php 
                            if(empty($row['board_name']) || $row['board_name']=='0'){
                             }else{
                              echo $row['board_name'];
                             }
                   ...
                   <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                             <?php 
                            if( empty($row['bank_name']) || $row['bank_name']=='0'){
                              ?>
                               <input  type="text" class="mdc-text-field__input" value="" name="bank_name" placeholder="Bank Name">
                          <?php   }else{
                            ?>
                            <input  type="text" readonly="" class="mdc-text-field__input" value="<?php 
                     ...
                     <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <?php 
                            if( empty($row['bank_branch_name']) || $row['bank_branch_name']=='0'){
                              ?>
                               <input  type="text" class="mdc-text-field__input" value="" name="bank_branch" placeholder="Branch Name">
                          <?php   }else{
                            ?>
                             <input  type="text" readonly="" class="mdc-text-field__input" value="<?php 
                      ...
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            ...
                            <?php 
                            if( empty($row['ac_no']) || $row['ac_no']=='0'){
                              ?>
                               <input  type="text" class="mdc-text-field__input" value="" name="bank_acc" placeholder="Bank Account Number">
                          <?php   }else{
                            ?>
                             <input  type="text" readonly="" class="mdc-text-field__input" value="<?php 
                      ...
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            ...
                            <?php 
                            if( empty($row['ifsc']) || $row['ifsc']=='0'){
                              ?>
                               <input  type="text" class="mdc-text-field__input" value="" name="bank_ifsc" placeholder="IFSC Code">
                          <?php   }else{
                            ?>
                             <input  type="text" readonly="" class="mdc-text-field__input" value="<?php 
                    ...
                    <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-6-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box  w-100">
                            <?php 
                            if( empty($row['micr_no']) || $row['micr_no']=='0'){
                              ?>
                               <input type="text"  class="mdc-text-field__input" value="" name="bank_micr" placeholder="MICR Number">
                          <?php   }else{
                            ?>
                             <input type="text" readonly="" class="mdc-text-field__input" value="<?php 
                    ...
                    <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-12-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <?php 
                            if( empty($row['branch_adds']) || $row['branch_adds']=='0'){
                              ?>
                               <input  type="text" class="mdc-text-field__input" value="" name="bank_branch_adds" placeholder="Branch Addres">
                          <?php   }else{
                            ?>
                             <input  type="text" readonly="" class="mdc-text-field__input" value="<?php 
                   ...
                   <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <input  type="text" class="mdc-text-field__input" value="<?php 
                            if(empty($row['nominee_name']) || $row['nominee_name']=='0'){
                             }else{
                     ...
                     <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4-desktop">
                      <div class="template-demo">
                        <div id="demo-tf-box-wrapper">
                          ...
                          <div class="mdc-text-field mdc-text-field--box w-100">
                            <input  type="text" class="mdc-text-field__input" value="<?php 
                            if(empty($row['nominee_rel']) || $row['nominee_rel']=='0'){
                             }else{
