...
<div class="modal fade log-background" id="loginmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <li class="nav-item" role="presentation">
    <a class="nav-link active link text-light" id="pills-POSP-tab" data-toggle="pill" href="#pills-POSP" role="tab" aria-controls="pills-POSP" aria-selected="false">POSP Login</a>
  </li>
 <!--  <li class="nav-item" role="presentation">
...
<div class="tab-content mt-5" id="pills-tabContent">
  ...
  <div class="tab-pane fade fade show active" id="pills-POSP" role="tabpanel" aria-labelledby="pills-POSP-tab">
     <div class="col-md-6 m-auto">
              <div class="login-box shadow bg-light text-center p-3">
                 <div class="login-img">
                 <span><i class="icon-user"></i></span>
                 ...
                 <form method="post" enctype="multipart/form-data" autocomplete="off">
                   <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <small id="forgetpassword" class="form-text text-muted text-left"><a href="#" style="color:red;font-weight:bold;">Forgot Password</a></small>
                   </div>
                   <div class="form-group">
                     <input type="submit" class="form-control btn btn-danger" name="agent_register" value="Login">
                     <small id="forgetpassword" class="form-text text-muted"><a href="agentregister.php" style="color:red;font-weight:bold;text-align: left;" >If you don't have account register Now</a></small>

<div class="" style="font-weight: bold;text-align: left;font-size: 11px;padding-top: 5px;">**For new registration, please contact on +91 7369942034, once u registered.</div>
                   </div>
   <?php             
...
/*session_start();
  ...
  location.href='agent/access.php?id=$idd' </script>";
...
/*session_start();
  ...
  //$_SESSION['mail'] = $idd;
echo "<script language='javascript' type='text/javascript'>alert('Logged In Successfully')
  location.href='corporate/corporate_access.php?id=$cor_idd' </script>";
  /*header("Location:agent/agent_dashboard.php");*/
      ...
      <div class="container">
        <div class="site-navbar bg-light">
          <div class="row align-items-center" style="background-color: #87CEEB;">
            <div class="col-2">
            <a href="index.php"><img style="width: 220px;" src="images/shadow_logo2.png"></a>
                ...
                <div class="container">
                  ...
                  <ul class="site-menu js-clone-nav d-none d-lg-block">
                     ...
                     <li class="has-children">
                      ...
                      <ul class="dropdown arrow-top">
                       ...
                       <!--   <li><a href="our_partners.php">Our Partners</a></li> -->
                        <li><a href="insurancebroker.php">Role of insurance broker</a></li>
                    ...
                    <li><a href="contact.php" style="color: #00529C;">Contact</a></li>
                     <li><a data-toggle="modal" data-target="#loginmodal" style="color: #00529C;">POSP Login</a></li>
