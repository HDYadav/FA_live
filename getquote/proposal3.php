          ...
          <div class="form-row">
           ...
           <div class="form-group col-md-4">
            ...
            <div class="form-group col-md-4">
             ...
             <input type="text" class="form-control" placeholder="Enter your PAN No" name="pan" > 
           </div>
          <div class="form-group col-md-4">
    ...
    <div class="card-body">
          ...
          <div class="form-row">
           <div class="form-group col-md-4">
             ...
             <input type="text" class="form-control" placeholder="Enter your address 1" name="addressone" > 
           </div>
            <div class="form-group col-md-4">
             <label class="control-label">Address line 2</label>
             <input type="text" class="form-control" placeholder="Enter your address  2" name="addresstwo" > 
           </div>
    ...
    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
        <div class="card-body">
          ...
          <div class="form-row">
              <div class="form-group col-md-4">
             <label class="control-label">TItle</label>
              <select name="membertitle" class="form-control"  >
                <option value="">Please Select</option>
                <option value="MR">MR</option>
                <option value="MRS">MRS</option>
                <option value="MISS">MiSS</option>
           ...
           <div class="form-group col-md-4">
            ...
            <div class="form-group col-md-4">
             <label class="control-label">Last Name</label>
             <input type="text" class="form-control" placeholder="Last Name" name="memberlast" > 
           </div>
           ...
           <div class="form-group col-md-4">
             <label class="control-label">Roll</label>
             <select  class="form-control" name="memberroll" >
           ...
           <div class="form-group col-md-4">
             <label class="control-label">DOB</label>
             <input type="text" class="form-control" placeholder="DOB" name="memberdob" > 
           </div>
        ...
        <div class="form-group col-md-4">
             <label class="control-label">Relation</label>
             <select name="memberrelation" class="form-control" >
            ...
            <div class="form-group col-md-4">
             <label class="control-label">E-mail</label>
             <input type="text" class="form-control" placeholder="Enter your E-mail" name="memberemail" > 
           </div>
           
            <div class="form-group col-md-4">
             <label class="control-label">PAN</label>
             <input type="text" class="form-control" placeholder="Enter your PAN No" name="memberpan" > 
           </div>
          <div class="form-group col-md-4">
             <label class="control-label">Mobile</label>
             <input type="text" class="form-control" placeholder="Enter your mobile No" name="membermobile" > 
           </div>
          </div>
