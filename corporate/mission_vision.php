           ...
           <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
              <div class="mdc-card">
                <section class="mdc-card__primary">
                  <h1 class="mdc-card__title mdc-card__title--large" style="color: #015198;">Mission & Vision</h1>
                </section>
...
$sql =mysql_query("UPDATE `cms` SET `m&v` = '$ename' WHERE `cms`.`id` = '1'");

if ($sql) 

  
      echo "<script language='javascript' type='text/javascript'>alert('Updated Successfully')
  location.href='../missionvission.php' </script>";
